...
namespace OFS
{
	namespace v2
	{
		...
		private:
			...
			// Potential additional fields from other programs OFS doesn't know about
			std::map<std::string, std::string> unknownFieldsJSON;
			std::map<std::string, std::string> unknownMetadataFieldsJSON;
		};
	}
